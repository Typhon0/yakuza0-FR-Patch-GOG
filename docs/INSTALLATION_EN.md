# Yakuza 0 GOG - French Translation Installation Guide (Rev 1.11.0)

This guide explains how to install the French fan-translation (VOSTFR Rev 1.11.0) on the **GOG DRM-free version** of **Yakuza 0**.
...
* The patch archive: **`Yakuza_0_Patch_FR_GOG_Rev1.11.0.7z`** (1.70 GB).
* [7-Zip](https://www.7-zip.org/) or [WinRAR](https://www.rarlab.com/) to extract `.7z` archives.
...
2. **Extract the patch files**:
   * Open **`Yakuza_0_Patch_FR_GOG_Rev1.11.0.7z`** with 7-Zip or WinRAR.
