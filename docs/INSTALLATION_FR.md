# Guide d'Installation - Yakuza 0 Patch Français (GOG Rev 1.11.0)

Ce guide détaille l'installation de la traduction française (VOSTFR Rev 1.11.0) pour l'édition **GOG** de **Yakuza 0**.
...
* L'archive du patch : **`Yakuza_0_Patch_FR_GOG_Rev1.11.0.7z`** (1,70 Go).
* Le logiciel [7-Zip](https://www.7-zip.org/) ou [WinRAR](https://www.rarlab.com/) pour extraire l'archive `.7z`.
...
2. **Copiez les fichiers du patch** :
   * Ouvrez l'archive **`Yakuza_0_Patch_FR_GOG_Rev1.11.0.7z`** avec 7-Zip ou WinRAR.
